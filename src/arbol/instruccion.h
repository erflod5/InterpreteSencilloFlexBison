...
/**
 * Clase abstracta que implementan todas las clases que son instrucción y que contiene 
 ...
 * clases que implementen esta clase abstracta están obligadas a tener un método programado
 * para la ejecución.
 */
class Instruccion{
    public:
         ...
         * resultado.
         */
        virtual Retorno* ejecutar(TablaDeSimbolos *ts){return NULL;};
};
#endif
